    ...
    for (const bulletId in gameState.bullets) {
        ...
        for (let step = 0; step < steps; step++) {
            ...
            for (let nearbyBullet of nearbyBullets) {
                ...
                if((gameState.bullets[bullet.id]!=undefined && gameState.bullets[otherBullet.id]!=undefined) && !(gameState.bullets[bullet.id].deleted || gameState.bullets[otherBullet.id].deleted)) break;
